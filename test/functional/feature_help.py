...
"""Verify that starting goldbcr with -h works as expected."""

from test_framework.test_framework import GoldBCRTestFramework
from test_framework.util import assert_equal

class HelpTest(GoldBCRTestFramework):
    ...
    def run_test(self):
        self.log.info("Start goldbcr with -h for help text")
        ...
        self.log.info("Start goldbcr with -version for version information")
        ...
        self.log.info("Start goldbcrd with -fakearg to make sure it does not start")
