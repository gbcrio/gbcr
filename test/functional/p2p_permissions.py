...
class P2PPermissionsTests(GoldBCRTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].goldbcrconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].goldbcrconf, 'w', encoding="utf8") as f:
            f.write(newText)
