...
By default, goldbcrd will dump mempool on shutdown and
...
class MempoolPersistTest(GoldBCRTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent goldbcrd from writing mempool.dat to disk. Verify that `savemempool` fails")
