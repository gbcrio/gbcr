...
/** GoldBCR unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GoldBCRUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GoldBCRUnits(QObject *parent);

    /** GoldBCR units.
      @note Source: https://en.goldbcr.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GBCR,
...
typedef GoldBCRUnits::Unit GoldBCRUnit;
