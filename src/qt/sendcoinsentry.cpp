    ...
    platformStyle(_platformStyle)
{
    ...
    // normal goldbcr address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying goldbcr address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &GoldBCRAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
