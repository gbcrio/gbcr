...
//! Entry point for Gold BCRApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &Gold BCRApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for Gold BCRGUI tests.
void AppTests::guiTests(Gold BCRGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &Gold BCRGUI::consoleShown, this, &AppTests::consoleTests);
