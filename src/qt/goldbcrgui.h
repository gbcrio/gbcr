...
/**
  GoldBCR GUI main class. This class represents the main window of the GoldBCR UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GoldBCRGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GoldBCRGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~GoldBCRGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a goldbcr wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
