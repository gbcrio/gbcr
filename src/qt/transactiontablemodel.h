...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, GoldBCRUnits::SeparatorStyle separators=GoldBCRUnits::separatorStandard) const;
