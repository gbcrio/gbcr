    ...
    mapper(nullptr)
{
    ...
    ui->goldbcrAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->goldbcrAtStartup);
    ...
    ui->goldbcrAtStartup->setToolTip(ui->goldbcrAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->goldbcrAtStartup->setText(ui->goldbcrAtStartup->text().arg(PACKAGE_NAME));

    ui->openGoldBCRConfButton->setToolTip(ui->openGoldBCRConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new GoldBCRUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->goldbcrAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGoldBCRConfButton_clicked()
{
