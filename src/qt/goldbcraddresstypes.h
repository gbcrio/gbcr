...
/** GoldBCR adress type definitions. Encapsulates parsing
   and serves as list model for drop-down selection boxes.
*/
class GoldBCRAddressTypes: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GoldBCRAddressTypes(QObject *parent);
...
typedef GoldBCRAddressTypes::AddressType GoldBCRAddressType;
