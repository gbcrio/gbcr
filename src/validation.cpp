...
#if defined(NDEBUG)
# error "Gold BCR cannot be compiled without assertions."
#endif
...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!m_pool.CalculateMemPoolAncestors(*entry, setAncestors, m_limit_ancestors, m_limit_ancestor_size, m_limit_descendants, m_limit_descendant_size, errString)) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/goldbcr-dev/2018-November/016518.html
...
{   
    ...
    if (nHeight == 1)
        ...
        // Mine 3,000,001 at the COINBASE
        return 3000000.001 * COIN;

    CAmount nSubsidy = 0.001 * COIN;
    ...
    // In ~66 years 4 months
    if (halvings >= 4)
        return 0;

    if (halvings == 3)
        // this adjustment assures the rewards run out after this halving
        halvings = 2;

    // Subsidy is cut in half every 1,500,000 blocks which will occur approximately every 16 years 8 months.
    nSubsidy >>= halvings;
    ...
    try {
        ...
        while (!blkdat.eof()) {
            ...
            try {
                ...
                // In Gold BCR POW this only needed to be done for genesis and at the end of block indexing
