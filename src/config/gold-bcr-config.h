/* src/config/goldbcr-config.h.  Generated from goldbcr-config.h.in by configure.  */
/* src/config/goldbcr-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "GBCR Developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Gold BCR Core"
...
#define PACKAGE_BUGREPORT "https://github.com/gold-bcr/gold-bcr/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Gold BCR Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Gold BCR Core 0.20.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gold-bcr"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://goldbcr.io/"
