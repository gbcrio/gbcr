...
#define COPYRIGHT_HOLDERS "The %s"

/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The GBCR"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "GBCR"
...
#define PACKAGE_BUGREPORT "https://github.com/gbcrio/gbcr"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Gold BCR Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Gold BCR Core 0.1.3"
