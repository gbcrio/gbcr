# Support for Output Descriptors
...
- P2SH addresses (base58, of the form `3...` for mainnet or `2...` for testnet, defined in [BIP 13](https://github.com/goldbcr/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32, of the form `bc1...` for mainnet or `tb1...` for testnet, defined in [BIP 173](https://github.com/goldbcr/bips/blob/master/bip-0173.mediawiki)).
...
on Gold BCR's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
the entire path from the master down. [BIP174](https://github.com/goldbcr/bips/blob/master/bip-0174.mediawiki) standardizes this by
...
existing Gold BCR Core wallets, a convenience function `combo` is
...
All RPCs in Gold BCR Core will include the checksum in their output. Only
