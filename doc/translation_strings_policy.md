...
This document provides guidelines for internationalization of GBCR software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `goldbcr_en.ts` remains unchanged.
