# Bootstrappable Gold BCR Core Builds

This directory contains the files necessary to perform bootstrappable Gold BCR
Core builds.
...
- 24GB of free disk space on the partition that GBCR git repository
  resides in
...
For a Gold BCR Core depends development environment, simply invoke
...
From the top of a clean Gold BCR Core repository:
...
To use dongcarl's substitute server for Gold BCR Core builds after having
