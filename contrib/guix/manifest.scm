...
(define* (make-goldbcr-cross-toolchain target
                                  #:key
...
desirable for building Gold BCR Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-goldbcr-cross-toolchain "i686-linux-gnu")
       (make-goldbcr-cross-toolchain "x86_64-linux-gnu")
       (make-goldbcr-cross-toolchain "aarch64-linux-gnu")
       (make-goldbcr-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-goldbcr-cross-toolchain "riscv64-linux-gnu"
