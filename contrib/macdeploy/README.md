...
When complete, it will have produced `Gold BCR-Qt.dmg`.
...
the file-order will change between invocations. The patch can be seen here: [cdrkit-deterministic.patch](https://github.com/goldbcr/goldbcr/blob/master/depends/patches/native_cdrkit/cdrkit-deterministic.patch).
